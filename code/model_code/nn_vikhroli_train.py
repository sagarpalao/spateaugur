...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/vikhroli.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'GHATKOPAR_M', 'GHATKOPAR_D', 'GHATKOPAR_C', 'GHATKOPAR_EAST_V', 'GHATKOPAR_EAST_F', 'MULUND_T']]
