...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/sion.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'MUMBAI_CENTRAL_V', 'MUMBAI_CENTRAL_F', 'CHEMBUR_EAST_DI', 'CHEMBUR_EAST_TY', 'CHEMBUR_EAST_CHO', 'CHEMBUR_EAST_J', 'KURLA_DI', 'KURLA_TY', 'KURLA_CHO', 'KURLA_J']]
data_y = df[['MALARIA', 'DENGUE', 'CHICKENGUNIA', 'VIRAL_FEVER', 'FLU', 'TUBERCULOSIS', 'DIARROHEA', 'TYPHOID', 'CHOLERA', 'JAUNDICE']]
modelname = '../model_trained/sion/model_sion.cpkt'
