...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/mulund_east.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'MULUND_WEST_DI', 'MULUND_WEST_TY', 'MULUND_WEST_CHO', 'MULUND_WEST_J']]
