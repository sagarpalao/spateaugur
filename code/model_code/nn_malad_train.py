...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/malad.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'KANDIVALI_WEST_M', 'KANDIVALI_WEST_D', 'KANDIVALI_WEST_C', 'GOREGAON_DI', 'GOREGAON_TY', 'GOREGAON_CHO', 'GOREGAON_J']]
