...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/dadar.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'KHAR_M', 'KHAR_D', 'KHAR_C']]
data_y = df[['MALARIA', 'DENGUE', 'CHICKENGUNIA', 'VIRAL_FEVER', 'FLU', 'TUBERCULOSIS', 'DIARROHEA', 'TYPHOID', 'CHOLERA', 'JAUNDICE']]
modelname = '../model_trained/dadar/model_dadar.cpkt'
