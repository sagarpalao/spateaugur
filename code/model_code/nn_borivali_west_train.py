...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/borivali_west.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'GOREGAON_M', 'GOREGAON_D', 'GOREGAON_C', 'MALAD_M', 'MALAD_D', 'MALAD_C', 'MALAD_T']]
