...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/goregaon.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'BANDRA_WEST_M', 'BANDRA_WEST_D', 'BANDRA_WEST_C']]
data_y = df[['MALARIA', 'DENGUE', 'CHICKENGUNIA', 'VIRAL_FEVER', 'FLU', 'TUBERCULOSIS', 'DIARROHEA', 'TYPHOID', 'CHOLERA', 'JAUNDICE']]
modelname = '../model_trained/goregaon/model_goregaon.cpkt'
