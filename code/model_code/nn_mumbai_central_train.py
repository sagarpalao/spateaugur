...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/mumbai_central.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'COLABA_V', 'COLABA_F', 'KURLA_T', 'NAGPADA_DI', 'NAGPADA_TY', 'NAGPADA_CHO', 'NAGPADA_J']]
