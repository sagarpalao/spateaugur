...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/juhu.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'BORIVALI_WEST_M', 'BORIVALI_WEST_D', 'BORIVALI_WEST_C', 'BORIVALI_WEST_T', 'ANDHERI_DI', 'ANDHERI_TY', 'ANDHERI_CHO', 'ANDHERI_J']]
