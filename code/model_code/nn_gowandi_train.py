...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/gowandi.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'CHEMBUR_EAST_DI', 'CHEMBUR_EAST_TY', 'CHEMBUR_EAST_CHO', 'CHEMBUR_EAST_J']]
