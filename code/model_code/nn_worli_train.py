...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/worli.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'NAGPADA_DI', 'NAGPADA_TY', 'NAGPADA_CHO', 'NAGPADA_J', 'MUMBAI_CENTRAL_DI', 'MUMBAI_CENTRAL_TY', 'MUMBAI_CENTRAL_CHO', 'MUMBAI_CENTRAL_J']]
