...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/vile_parle.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'MUMBAI_CENTRAL_DI', 'MUMBAI_CENTRAL_TY', 'MUMBAI_CENTRAL_CHO', 'MUMBAI_CENTRAL_J']]
