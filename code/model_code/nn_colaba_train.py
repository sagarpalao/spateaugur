...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/colaba.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'MULUND_M', 'MULUND_D', 'MULUND_C', 'MULUND_EAST_M', 'MULUND_EAST_D', 'MULUND_EAST_C', 'PAREL_V', 'PAREL_F', 'NAGPADA_V', 'NAGPADA_F', 'AGRIPADA_T']]
data_y = df[['MALARIA', 'DENGUE', 'CHICKENGUNIA', 'VIRAL_FEVER', 'FLU', 'TUBERCULOSIS', 'DIARROHEA', 'TYPHOID', 'CHOLERA', 'JAUNDICE']]
modelname = '../model_trained/colaba/model_colaba.cpkt'
