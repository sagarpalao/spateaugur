...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/kandivali_west.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'KANDIVALI_WEST_M', 'KANDIVALI_WEST_D', 'KANDIVALI_WEST_C', 'KANDIVALI_WEST_DI', 'KANDIVALI_WEST_TY', 'KANDIVALI_WEST_CHO', 'KANDIVALI_WEST_J']]
