...
df = pd.read_csv('../preparing_data/raw/REFINEDDATA/kurla.csv')
data_X = df[['S_D', 'S_M', 'TEMP_C', 'RAIN_MM', 'AQI', 'CHEMBUR_EAST_DIARROHEA', 'CHEMBUR_EAST_TYPHOID', 'CHEMBUR_EAST_CHOLERA', 'CHEMBUR_EAST_JAUNDICE', 'JUHU_T', 'VIKHROLI_T']]
